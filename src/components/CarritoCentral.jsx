...
export default function CarritoCentral({ items, totalItems, totalPesos, onCambiar, onQuitar, onVaciar, onCerrar }) {
  const [paso,     setPaso]     = useState("lista");   // "lista" | "confirmar"
  ...
  return (
    <>
      <motion.div
        ...
        onClick={paso === "lista" ? onCerrar : volver}
        ...
        <div style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            ...
            <h2 style={{ margin: 0, fontWeight: 800, fontSize: "1.1rem", color: "#eee" }}>
              {paso === "confirmar" ? "Confirmar pedido" : "Tu pedido"}
            </h2>
        ...
        {paso === "lista" && (
          <>
            ...
            <div style={{
              ...
              <button
                onClick={() => items.length > 0 && setPaso("confirmar")}
