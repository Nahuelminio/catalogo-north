...
export default function CarritoCentral({ items, totalItems, totalPesos, onCambiar, onQuitar, onVaciar, onCerrar }) {
  ...
  const enviar = async () => {
    ...
    try {
      await fetch(`${API_BASE}/pedidos-central`, {
        method: "POST",
      ...
      // No bloqueamos el flujo si el backend falla — el WA igual se abre
    } finally {
      setEnviando(false);
    }
        ...
        <div style={{
          ...
          <button
            ...
            style={{
              ...
              cursor: (items.length === 0 || enviando) ? "default" : "pointer",
          ...
          >
            ...
            {enviando ? "Guardando pedido…" : "Enviar pedido por WhatsApp"}
          </button>
